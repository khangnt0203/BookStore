...
import khangnt.DAO.CategoryDAO;
import khangnt.DAO.ProductDAO;
import khangnt.DTO.CategoryDTO;
...
public class ProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            listProduct = dao.getAllProductForUser();
            if (dto != null) {
                if ("AD".equals(dto.getRoleID())) {
                    listProduct = dao.getAllProductForAdmin();
                }
            }
            ...
            request.setAttribute("ACTIONSEARCH", "homePage");
