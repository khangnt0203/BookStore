...
public class searchByNameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try { // zzoong tui đi ra đây 10p nhé ok
            ...
            if (dto != null) {
                if ("AD".equals(dto.getRoleID())) {
                    listProduct = dao.searchAllProductByNameforAdmin(searchValue);
                }
            }
            listProduct = dao.searchAllProductByNameforUser(searchValue);
            request.setAttribute("listProduct", listProduct);
            request.setAttribute("ACTIONSEARCH", "searchByName");
