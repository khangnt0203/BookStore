 ...
 * @author DELL
 */
@WebServlet(name = "updateQuantityProductServlet", urlPatterns = {"/updateQuantityProductServlet"})
public class updateQuantityProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int proQuantity = Integer.parseInt(request.getParameter("proQuantity"));
        String pk = request.getParameter("proID");
        ...
        try {
            ...
            if (cart != null) {
                ...
                if (error == null) {
                    cart.getCartProduct().get(pk).setQuantity(proQuantity);
                }
            }
