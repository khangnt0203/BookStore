<%-- 
    Document   : search.jsp
    Created on : Aug 15, 2021, 2:15:29 PM
    Author     : SE140281
--%>
                ...
                <div class="col">
                    ...
                    <div class="row"> 
                        <c:forEach var="item" items="${listProduct}">
                            <div class="col-3">
                                <div class="card" style="height: 550px; width: 200px; margin-top: 20px">
                                    <img class="card-img-top"  style="width: 100%; height: 300px" src="img/${item.productImg}" alt="abc" />
                                    <div class="card-body">
                                        <h4 class="card-title">${item.productName}</h4>
                                        <p class="card-text">Price: ${item.price}$</p>
                                        <p class="card-text" style="color: red">Quantity: ${item.quantity}</p>
                                    </div>
